...
public class Validation {
    ...
    public static void main(String[] args) {
        ...
        if(number > 10){
            ...
            JOptionPane.showMessageDialog(null, "That number is not greater than 10. Try again.");
            number = Integer.parseInt(JOptionPane.showInputDialog("Please enter a number greater than 10"));
        }
